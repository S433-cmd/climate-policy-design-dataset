...
# Data Availability Release Note & Access

The complete **ClimateGen dataset (Version 1.0.0)** is now publicly available via the GESIS Data Archive. 
You can access and download the data here: [https://doi.org/10.7802/3038](https://doi.org/10.7802/3038).

**How to use the data with this repository:**
To reproduce the processing steps or run the descriptive analyses, please download the dataset from GESIS and place the files into the corresponding directories:
- `data/raw/` (snapshots of source exports, where licensing permits)
- `data/processed/` (intermediate files generated by the scripts)
- `data/final/` (the final DCCSR release files)
